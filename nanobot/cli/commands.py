...
# Import and register direct commands
...
from nanobot.cli.rag import rag_app
from nanobot.cli.security import security_app
...
# Register OAuth login handlers (keep in commands.py for now)
